...
class WalalBottomBar extends StatefulWidget {
  const WalalBottomBar({super.key});

  @override
  State<WalalBottomBar> createState() => _WalalBottomBarState();
}

class _WalalBottomBarState extends State<WalalBottomBar> {
  int numberOfPages = 5;
  int currentPage = 0;
  @override
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const BaleScreen()),
                          );
                        },
                        child: Container(
